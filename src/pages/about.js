    ...
    <Layout>
      ...
      >
        ...
        <p>
          ...
          revolved around books and stories. She majored in English Literature
          at Fordham University, worked as a bookseller at Borders after
          college, was an editorial assistant at an academic press in New York
          City, became an early elementary school teacher in the Pacific
          Northwest, and now writes books for kids while homeschooling her own
          young children. In addition to children’s fiction, Christie writes
          short stories for adults and essays on topics such as motherhood,
          homeschooling, and progressive education. When she isn’t writing, she
          spends her time baking butter-laden desserts, hiking through the
          woods, and practicing her tree pose with the forest fairies.​SCBWI
          Member
        </p>
        <p>True facts</p>
        <ol>
